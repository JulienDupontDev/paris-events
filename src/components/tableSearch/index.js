        ...
        <Grid item xs={6} sm={4}>
          <Autocomplete
            ...
            onChange={(event, values) => {
              if (values.length === 0) {
                this.setState({
                  userFilters: { ...this.state.userFilters, tags: [] }
                })
                return
              }
              this.setState({
          ...
          <FormControl component='fieldset'>
            <FormGroup>
              <FormControlLabel
                control={
                  <Switch
                    checked={this.state.userFilters.pmr.value === 1}
                    onChange={() => {
                      this.setState({
                        ...this.state,
                        userFilters: {
                          ...
                          pmr: {
                            value:
                              this.state.userFilters.pmr.value === 0 ? 1 : 0,
                            facet: 'pmr'
                          }
                        }
                      })
          ...
          <FormControl component='fieldset'>
            <FormGroup>
              <FormControlLabel
                control={
                  <Switch
                    checked={this.state.userFilters.blind.value === 1}
                    onChange={() => {
                      this.setState({
                        ...this.state,
                        userFilters: {
                          ...
                          blind: {
                            value:
                              this.state.userFilters.blind.value === 0 ? 1 : 0,
                            facet: 'blind'
                          }
                        }
                      })
          ...
          <FormControl component='fieldset'>
            <FormGroup>
              <FormControlLabel
                control={
                  <Switch
                    checked={this.state.userFilters.deaf.value === 1}
                    onChange={() => {
                      this.setState({
                        ...this.state,
                        userFilters: {
                          ...
                          deaf: {
                            value:
                              this.state.userFilters.deaf.value === 0 ? 1 : 0,
                            facet: 'deaf'
                          }
                        }
                      })
